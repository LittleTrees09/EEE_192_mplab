...
"||                                                    ||\r\n"
"||  STATUS: \033[31mOFF\033[0m  --  Press onboard button to enable.  ||\r\n"
"||                                                    ||\r\n"
"||  [M] Manual       [U] IR Follow     [O] Ultrasonic ||\r\n"
"==========================================================\r\n";

static const char UI_MANUAL_HEAD[] =
"\033[2J\033[H"
"==========================================================\r\n"
"||  EEE 192 MoBot  |  STATUS: \033[32mON\033[0m  |  MODE: \033[36mMANUAL\033[0m        ||\r\n"
"||  Baud: 9600                                        ||\r\n"
"||                                                    ||\r\n"
"||  [W] Fwd  [S] Bk  [A] Left  [D] Right  [SPC] Stop ||\r\n"
"||  [UP] Speed+         [DOWN] Speed-       [T] Test  ||\r\n"
"||                                                    ||\r\n"
"||  [M] Manual       [U] IR Follow     [O] Ultrasonic ||\r\n"
"==========================================================\r\n";
...
"\033[2J\033[H"
"==========================================================\r\n"
"||  EEE 192 MoBot  |  STATUS: \033[32mON\033[0m  |  MODE: \033[33mIR FOLLOW\033[0m     ||\r\n"
"||  Baud: 9600                                        ||\r\n"
"||                                                    ||\r\n"
#if (IR_AUTO_POLICY == IR_POLICY_MOVE_IF_DETECT)
"||  Move toward black  |  Stop if no black detected   ||\r\n"
"||  Left black->Left   |  Right black->Right          ||\r\n"
#else
"||  Move if NO sensor sees black                      ||\r\n"
"||  Stop  if ANY sensor sees black                    ||\r\n"
#endif
"||                                                    ||\r\n"
"||  [SPC] Pause  [U] Resume  [X] Clear Safe  [Z] Dbg ||\r\n"
"||  Safe: button press | no line detected for 3s      ||\r\n"
"||                                                    ||\r\n"
"||  [M] Manual       [U] IR Follow     [O] Ultrasonic ||\r\n"
"==========================================================\r\n";
...
"\033[2J\033[H"
"==========================================================\r\n"
"||  EEE 192 MoBot  |  STATUS: \033[32mON\033[0m  |  MODE: \033[35mULTRASONIC\033[0m    ||\r\n"
"||  Baud: 9600                                        ||\r\n"
"||                                                    ||\r\n"
"||  Clear->Full  |  <40cm->Slow  |  <25cm->Stop+Turn  ||\r\n"
"||  Sides: <20cm Close  |  <35cm Medium  ->Steer away ||\r\n"
"||                                                    ||\r\n"
"||  [SPC] Pause       [O] Resume       [X] Clear Safe ||\r\n"
"||                                                    ||\r\n"
"||  [M] Manual       [U] IR Follow     [O] Ultrasonic ||\r\n"
"==========================================================\r\n";
                ...
                if (stable_state != reading) {
                    ...
                    if (stable_state) {
                        if (controls_on && (mode == DRIVE_MODE_AUTO_IR) && auto_run_enabled && !safe.active) {
                            // Button during active IR follow → SAFE
